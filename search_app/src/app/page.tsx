...
const TopBar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 flex items-center px-6 z-50">
      <h1 className="text-2xl font-serif text-gray-900 tracking-tight">Lotus</h1>
    </div>
  );
};
            ...
            {!hasSubmitted ? (
              ...
              >
                <div className="text-center mb-12">
                  ...
                  <h1 className="text-5xl font-serif text-gray-900 mb-4 tracking-tight">Your AI Powered DeFi Research Assistant</h1>
                  <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto leading-relaxed">
                    Stay effortlessly updated on news and regulations.
                  </p>
                </div>
